...
#ifndef _LivermoreStrategyTest
#define _LivermoreStrategyTest
...
class LivermoreStrategyTest : public ctaTemplate{
...
public:
    ...
    LivermoreStrategyTest(){
        ctaTemplate();
        this->setStrategyName("LivermoreStrategyTest");
    }
